        ...
        {trendingArticles.map((article, index) => {
          ...
          return (
            <Link
              ...
              className="group flex items-start gap-3 p-3 -mx-3 rounded-xl hover:bg-neutral-100 dark:hover:bg-black transition-colors focus-ring"
              role="listitem"
            >
              {/* Rank Number */}
              <span
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${defaultSourceColor}`}
                    aria-hidden="true"
                  />
