        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="group p-3 bg-neutral-900 rounded-xl hover:bg-white hover:scale-110 active:scale-95 transition-all duration-300 focus-ring border border-neutral-800 hover:border-white"
                aria-label="View on GitHub"
              >
                <svg className="w-5 h-5 text-neutral-400 group-hover:text-black transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <nav aria-label="Markets">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="group text-neutral-400 hover:text-white transition-colors inline-flex items-center gap-3 focus-ring rounded px-1 -mx-1">
              ...
              <li>
                <Link href="/movers" className="group text-neutral-400 hover:text-white transition-colors inline-flex items-center gap-3 focus-ring rounded px-1 -mx-1">
              ...
              <li>
                <Link href="/trending" className="group text-neutral-400 hover:text-white transition-colors inline-flex items-center gap-3 focus-ring rounded px-1 -mx-1">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fillRule="evenodd" d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.88-.214.33-.403.713-.57 1.116-.334.804-.614 1.768-.84 2.734a31.365 31.365 0 00-.613 3.58 2.64 2.64 0 01-.945-1.067c-.328-.68-.398-1.534-.398-2.654A1 1 0 005.05 6.05 6.981 6.981 0 003 11a7 7 0 1011.95-4.95c-.592-.591-.98-.985-1.348-1.467-.363-.476-.724-1.063-1.207-2.03zM12.12 15.12A3 3 0 017 13s.879.5 2.5.5c0-1 .5-4 1.25-4.5.5 1 .786 1.293 1.371 1.879A2.99 2.99 0 0113 13a2.99 2.99 0 01-.879 2.121z" clipRule="evenodd" /></svg>
                  <span className="text-sm font-medium">Trending</span>
                </Link>
              </li>
              <li>
                <Link href="/defi" className="group text-neutral-400 hover:text-white transition-colors inline-flex items-center gap-3 focus-ring rounded px-1 -mx-1">
              ...
              <li>
                <Link href="/sentiment" className="group text-neutral-400 hover:text-white transition-colors inline-flex items-center gap-3 focus-ring rounded px-1 -mx-1">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
