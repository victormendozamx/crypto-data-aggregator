        ...
        <div className="space-y-4">
          ...
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-4 border border-neutral-200 dark:border-neutral-800">
            <div className="flex items-center justify-between">
              <div>
                <span className="text-neutral-500 dark:text-neutral-400 text-xs uppercase tracking-wider font-medium">Total Market Cap</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-3.5 border border-neutral-200 dark:border-neutral-800">
              <span className="text-neutral-500 dark:text-neutral-400 text-xs uppercase tracking-wider font-medium">24h Volume</span>
              <div className="text-lg font-bold text-neutral-900 dark:text-white mt-1">
                ${formatNumber(market.global.total_volume?.usd)}
              </div>
            </div>
            <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-3.5 border border-neutral-200 dark:border-neutral-800">
              <span className="text-neutral-500 dark:text-neutral-400 text-xs uppercase tracking-wider font-medium">BTC Dom.</span>
          ...
          {market.fearGreed && (
            <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-4 border border-neutral-200 dark:border-neutral-800">
              <div className="flex items-center justify-between mb-3">
                <span className="text-neutral-500 dark:text-neutral-400 text-xs uppercase tracking-wider font-medium">Fear & Greed Index</span>
          ...
          {market.trending.length > 0 && (
            <div className="pt-2">
              <p className="text-neutral-500 dark:text-neutral-400 text-xs uppercase tracking-wider font-medium mb-3 flex items-center gap-2">
                <span className="w-4 h-4 rounded bg-black dark:bg-white flex items-center justify-center" aria-hidden="true">
