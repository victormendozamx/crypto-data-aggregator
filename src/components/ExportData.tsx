  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={exporting}
        className={`flex items-center gap-2 px-3 py-2 text-sm font-medium border border-surface-border rounded-lg hover:bg-surface-alt transition-colors disabled:opacity-50 ${className}`}
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-1 z-50 w-40 bg-surface border border-surface-border rounded-lg shadow-lg py-1">
            <button
              onClick={() => handleExport('csv')}
              className="w-full flex items-center gap-3 px-3 py-2 text-sm hover:bg-surface-alt transition-colors"
            >
