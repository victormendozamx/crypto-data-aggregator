    ...
    <div className="min-h-screen bg-white dark:bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="h-10 w-64 bg-neutral-200 dark:bg-black rounded animate-pulse mx-auto mb-2" />
        ...
        <div className="flex justify-center gap-4 mb-8">
          {[...Array(3)].map((_, i) => (
            ...
            >
              <div className="w-6 h-6 bg-neutral-200 dark:bg-black rounded-full animate-pulse" />
              <div className="h-4 w-16 bg-neutral-200 dark:bg-black rounded animate-pulse" />
            </div>
          ))}
        </div>
        ...
        <div className="bg-neutral-50 dark:bg-black rounded-xl border border-neutral-200 dark:border-neutral-800 overflow-hidden">
          ...
          <div className="grid grid-cols-4 gap-4 p-4 border-b border-neutral-200 dark:border-neutral-800">
            <div className="h-5 bg-neutral-200 dark:bg-black rounded animate-pulse" />
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                <div className="w-12 h-12 bg-neutral-200 dark:bg-black rounded-full animate-pulse" />
          ...
          {[...Array(8)].map((_, i) => (
            ...
            >
              ...
              {[...Array(3)].map((_, j) => (
                <div
                  key={j}
                  className="h-4 w-20 bg-neutral-200 dark:bg-black rounded animate-pulse mx-auto"
                />
              ))}
            </div>
          ))}
