...
const sentimentColors: Record<string, { text: string; bg: string; border: string }> = {
  very_bullish: { text: 'text-neutral-900 dark:text-white', bg: 'bg-neutral-100 dark:bg-neutral-800', border: 'border-neutral-300 dark:border-neutral-600' },
  bullish: { text: 'text-neutral-900 dark:text-white', bg: 'bg-neutral-50 dark:bg-neutral-900', border: 'border-neutral-200 dark:border-neutral-700' },
  neutral: { text: 'text-neutral-600 dark:text-neutral-400', bg: 'bg-neutral-100 dark:bg-neutral-800', border: 'border-neutral-200 dark:border-neutral-700' },
  bearish: { text: 'text-neutral-500 dark:text-neutral-400', bg: 'bg-neutral-50 dark:bg-neutral-900', border: 'border-neutral-200 dark:border-neutral-700' },
  very_bearish: { text: 'text-neutral-500 dark:text-neutral-400', bg: 'bg-neutral-100 dark:bg-neutral-800', border: 'border-neutral-300 dark:border-neutral-600' },
};
  ...
  return (
    <div className="relative w-48 h-24 mx-auto">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="w-48 h-48 rounded-full border-[16px] border-neutral-200 dark:border-neutral-700" 
             style={{ 
        ...
        <main className="px-4 py-8">
          <div className="mb-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-neutral-900 dark:text-white">Market Sentiment</h1>
            </div>
          ...
          {data ? (
            <div className="space-y-8">
              ...
              <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div className="text-center">
                    <h2 className="text-lg text-neutral-500 dark:text-neutral-400 mb-4">Market Sentiment Score</h2>
                    <SentimentGauge score={data.market.score} />
                    <div className="mt-12">
                      <span className={`inline-flex items-center gap-2 px-6 py-3 rounded-full text-lg font-bold ${sentimentColors[data.market.overall]?.bg || 'bg-neutral-100 dark:bg-neutral-800'} ${sentimentColors[data.market.overall]?.text || 'text-neutral-600 dark:text-neutral-400'}`}>
                        {sentimentLabels[data.market.overall] || 'NEUTRAL'}
                      </span>
                    </div>
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-3 text-neutral-900 dark:text-white">Summary</h3>
                    <p className="text-neutral-700 dark:text-neutral-300 mb-4">{data.market.summary}</p>
                    
                    <h3 className="font-bold text-lg mb-3 text-neutral-900 dark:text-white">Key Drivers</h3>
              ...
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-xl font-bold text-neutral-900 dark:text-white">Article Analysis</h2>
                </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-4 mb-3">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${sentimentColors[article.sentiment]?.bg || 'bg-neutral-100 dark:bg-neutral-800'} ${sentimentColors[article.sentiment]?.text || 'text-neutral-600 dark:text-neutral-400'}`}>
                            {article.sentiment.replace('_', ' ')}
                          </span>
                          <span className={`text-xs px-2 py-0.5 rounded ${article.impactLevel === 'high' ? 'bg-neutral-200 dark:bg-neutral-700 text-neutral-900 dark:text-white font-semibold' : article.impactLevel === 'medium' ? 'bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400'}`}>
                            {article.impactLevel} impact
                          </span>
                        </div>
                      </div>
                      <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-3">{article.reasoning}</p>
            ...
            <div className="text-center py-16 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800">
              ...
              <h3 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 mb-2">Sentiment Analysis Unavailable</h3>
              <p className="text-neutral-500 dark:text-neutral-400 mb-4">AI features require GROQ_API_KEY to be configured</p>
