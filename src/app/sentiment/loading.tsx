      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-neutral-50 dark:bg-black rounded-xl border border-neutral-200 dark:border-neutral-800 p-8 mb-8">
          <div className="flex flex-col items-center">
            <div className="h-6 w-48 bg-neutral-200 dark:bg-black rounded animate-pulse mb-6" />
            <div className="w-48 h-48 bg-neutral-200 dark:bg-black rounded-full animate-pulse mb-4" />
            <div className="h-12 w-24 bg-neutral-300 dark:bg-black rounded animate-pulse mb-2" />
        ...
        <div className="bg-neutral-50 dark:bg-black rounded-xl border border-neutral-200 dark:border-neutral-800 p-6 mb-8">
          <div className="h-6 w-48 bg-neutral-200 dark:bg-black rounded animate-pulse mb-6" />
          <div className="h-64 bg-neutral-200 dark:bg-black rounded animate-pulse" />
        </div>
